...
#strDir = "C:/TTU_Spring_2017/Predictive_Analysis/midterm/input/Max/"
#strDir = "C:/TTU_Spring_2017/Predictive_Analysis/midterm/input/zip/stage1/"
...
var2 =data.frame(matrix(unlist(l), nrow=219, byrow=T))
